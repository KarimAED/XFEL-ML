...
x_train, x_test, y_train, y_test, inp_df, out_df = get_pump_data(undulators_2_datasets[1], include_probe=False)
...
plot_fit.plot_pvm(y_test, new_xgb.predict(x_te_filt),
                  label,
                  "Expected Pump CoM", "Predicted Pump CoM",
                  "pumpProbe2021/results/ex_2_pump_probe_corr/xgb_feat_pump_hist2d_no_corr")
...
np.savez("pumpProbe2021/results/ex_2_pump_probe_corr/xgb_10_feat_pump_pred.npz",
