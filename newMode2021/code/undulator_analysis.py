...
"""
different_undulators_datasets = ["LW8_Run_78_30000_events_4_undulators_210827.pkl",
                                 "LW8_Run_48_33170_events_5_undulators_210827.pkl"]
...
for i, label in enumerate(different_undulators_datasets):
    ...
    string_data = {
        ...
        "unit": "eV",
        "data_fname": "PaperFigures/Figure Data/Figure 4_5/new_u%s.npz" % str(i+4),
        "plot_fname": "newMode2021/results/ex_3_undulator_vary/probe_undulator_%s_hist2d" % str(i+4)
    }
