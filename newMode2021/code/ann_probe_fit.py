...
from newMode2021.code.setup import get_probe_data
...
string_data = {
    ...
    "plot_fname": "newMode2021/results/ex_4_probe_pred/ann_probe_wo_pump_2_no_corr"
}
...
string_data = {
    ...
    "plot_fname": "newMode2021/results/ex_3_undulator_vary/ann_probe_wo_pump_1_no_corr"
}
...
string_data = {
    ...
    "plot_fname": "newMode2021/results/ex_3_undulator_vary/ann_probe_wo_pump_3_no_corr"
}
